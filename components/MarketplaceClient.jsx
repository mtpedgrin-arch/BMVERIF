...
const css = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .support-fab { position: fixed; bottom: 28px; right: 28px; z-index: 400; display: flex; align-items: center; gap: 8px; background: #E02020; color: #fff; border: none; border-radius: 50px; padding: 12px 20px 12px 14px; font-size: 15px; font-weight: 700; cursor: pointer; box-shadow: 0 4px 20px rgba(224,32,32,0.45); transition: transform 0.15s, box-shadow 0.15s; text-decoration: none; letter-spacing: 0.01em; }
  .support-fab:hover { transform: translateY(-2px); box-shadow: 0 6px 28px rgba(224,32,32,0.55); }
  .support-fab svg { width: 20px; height: 20px; flex-shrink: 0; }
...
export default function App() {
  ...
  return (
    <div className={`app${darkMode ? " dark" : ""}`}>
      ...
      <a
        href="https://t.me/bmverificada_soporte"
        target="_blank"
